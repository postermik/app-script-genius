...
import type { StrategicMemoData } from "@/types/rhetoric";

interface Props {
  data: StrategicMemoData;
}

export function StrategicMemoView({ data }: Props) {
  ...
  const handleCopyAll = async () => {
    ...
    setCopied(true);
    toast.success("Strategic memo copied to clipboard");
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = "strategic-memo.txt";
    a.click();
    URL.revokeObjectURL(url);
    toast.success("Strategic memo downloaded.");
  };
